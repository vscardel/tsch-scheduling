...
print(f'Executando experimento com parametros num_cpus={args.num_cpus}, num_runs={args.num_runs}, combinations={args.combinations}, sched_function={args.sched_function}' )
